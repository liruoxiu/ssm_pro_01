...
public class StringHelper {
	...
	public static double getDouble(Map<String,Object> map, String keyName) {
	...
	public static float getFloat(Map<String,Object> map, String keyName) {
		String str= notEmpty(map.get(keyName));
		if(str.equals(""))
			str="0";
		return Float.parseFloat(str);
	}
	public static double getInt(Map<String,Object> map, String keyName) {
		String str= notEmpty(map.get(keyName));
		if(str.equals(""))
			str="0";
	 ...
	 * @return
	 */
	public static String getKeyValue(Map<String,Object> map, String keyName, Map<String,Object> resultMap) {
