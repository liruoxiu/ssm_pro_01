...
//				System.out.println("上传进度:" + process);
	...
	public static void main(String[] args) {
		...
		try {
			myFtp.connect("192.168.2.62", 21, "LV", "   ");
			myFtp.ftpClient.makeDirectory(new String("新文件夹".getBytes("GBK"),
					"iso-8859-1"));
			myFtp.ftpClient.changeWorkingDirectory(new String("新文件夹"
					.getBytes("GBK"), "iso-8859-1"));
//			System.out.println(myFtp.upload("D:/FTP下载/下载.xls",
//					"/FTP上传/上传1.xls"));
//			System.out.println(myFtp
//					.download("/FTP上传/上传1.xls", "D:/FTP下载/下载.xls"));
			myFtp.disconnect();
		} catch (IOException e) {
